    ...
    return (
        ...
        <div className="col-12 md:col-6 p-6 text-center md:text-left flex align-items-center h-screen">
            <section>
                ...
                <div className="text-6xl text-primary font-bold mb-3">al sistema de prestamos</div>
                <p className="mt-0 mb-4 text-700 line-height-3">Bienvenido al sistema de prestamos de nuestra universidad.</p>
            </section>
        </div>
